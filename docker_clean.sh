...
# ============================================
# Скрипт полной очистки Bocchi Downloader
# Удаляет контейнер, образ и папку ~/bocchi_bot
# ============================================
...
# Удаление папки проекта (используем $HOME вместо ~ для надёжности)
cd "$HOME" && rm -rf "$HOME/bocchi_bot" && echo "   Папка $HOME/bocchi_bot удалена" || echo "   Папка не найдена"
