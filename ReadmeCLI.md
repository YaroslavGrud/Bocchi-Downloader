...
# Bocchi Downloader — автономный офлайн‑пакет для Android

[![Platform](https://img.shields.io/badge/Platform-Android-green)](https://www.android.com)
[![Termux](https://img.shields.io/badge/Termux-Required-blue)](https://termux.com)
[![License](https://img.shields.io/badge/License-MIT-yellow)](LICENSE)

**Bocchi Downloader** — это инструмент для скачивания музыки с Яндекс.Музыки, упакованный в полностью автономный офлайн‑пакет.  
...
- Исправленный лаунчер `run_bocchi.sh` (активация venv, корректный вызов загрузчика)
...
- Установленный [Termux](https://f-droid.org/packages/com.termux/) (рекомендуется версия с F‑Droid)
- **≈3 ГБ** свободного места в памяти телефона
...
Введите ваш токен (Session_id) и пользуйтесь.

---

## 🚀 Повседневный запуск

Чтобы не вводить длинную команду каждый раз, создайте **алиас**:
...
### Где взять токен (Session_id)?
1. Откройте [music.yandex.ru](https://music.yandex.ru) в браузере и авторизуйтесь.
2. Нажмите F12 → вкладка **Application** (или «Хранилище»).
3. Найдите Cookies для `https://music.yandex.ru`.
4. Скопируйте значение cookie с именем `Session_id`.
